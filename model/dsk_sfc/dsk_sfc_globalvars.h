...
#include "modules/WITCH_input/rapidjson/rapidjson.h"
...
int              indsupl;                                    // C-firm's machine supplier
int              flag;                                       // Flag
...
double           p1test;                                     // Temporary storage for K-firm price         
...
double           Cresb;                                      // Temporary storage for residual consumption
...
double           lossdouble;                                 // Temporary storage for output and inventory losses
...
double           C_loss_share;                               // Share of C-Firms affected by shock to current output
double           K_loss_share;                               // Share of C-Firms affected by shock to capital stock
double           I_loss_share;                               // Share of K-Firms affected by shock to current output
...
RowVector        supl;                                       // C-firms' supplier of machine tools
...
double           govTranfers;                                // Government transfers to households  
...
double           D_en_TOT;                                   // Total energy demand
...
//Filenames 
/* Output file names are built by strcpy/strcat from the directory the
   executable was invoked from, so their length is whatever the caller's path
...
char filename4[PATH_MAX];                                          // File "A1_all" (inv_prodall1)  
char filename5[PATH_MAX];                                          // File "A2_all" (inv_prodall2)
char filename6[PATH_MAX];                                          // File "A1all_en" (inv_prodall1_en)
char filename7[PATH_MAX];                                          // File "A2all_en" (inv_prodall2_en)
char filename8[PATH_MAX];                                          // File "A1all_ef" (inv_prodall1_ef)
char filename9[PATH_MAX];                                          // File "A2all_ef" (inv_prodall2_ef)
char filename10[PATH_MAX];                                         // File "NW1all" (inv_nwall1)
char filename11[PATH_MAX];                                         // File "NW2all" (inv_nwall2)
char filename12[PATH_MAX];                                         // File "NWBall" (inv_nwall3)
char filename13[PATH_MAX];                                         // File "Deb2all" (inv_deball2)
char filename14[PATH_MAX];                                         // File "validation1" (inv_val1)
char filename15[PATH_MAX];                                         // File "validation2" (inv_val2)
char filename16[PATH_MAX];                                         // File "validation3" (inv_val3)
char filename17[PATH_MAX];                                         // File "validation4" (inv_val4)
char filename18[PATH_MAX];                                         // File "validation5" (inv_val5)
char filename19[PATH_MAX];                                         // File "validation6" (inv_val6)
char filename20[PATH_MAX];                                         // File "validation7" (inv_val7)
char filename21[PATH_MAX];                                         // File "validation8" (inv_val8)
char filename22[PATH_MAX];                                         // File "validation9" (inv_val9)
...
//WITCH inputs
rapidjson::Document eleprice_WITCH;                          // WITCH energy price file
rapidjson::Document carbon_price_WITCH;                      // WITCH carbon price file
rapidjson::Document share_biomass_WITCH;                     // WITCH share of biomass in energy mix file
rapidjson::Document share_coal_WITCH;                        // WITCH share of coal in energy mix file
rapidjson::Document share_gas_WITCH;                         // WITCH share of gas in energy mix file
rapidjson::Document share_hydro_WITCH;                       // WITCH share of hydro in energy mix file
rapidjson::Document share_nuclear_WITCH;                     // WITCH share of nuclear in energy mix file
rapidjson::Document share_oil_WITCH;                         // WITCH share of oil in energy mix file
rapidjson::Document share_solar_WITCH;                       // WITCH share of solar in energy mix file
rapidjson::Document share_wind_WITCH;                        // WITCH share of wind in energy mix file
rapidjson::Document om_biomass_WITCH;                        // WITCH fixed cost of biomass file                 
rapidjson::Document om_coal_WITCH;                           // WITCH fixed cost of coal file 
rapidjson::Document om_gas_WITCH;                            // WITCH fixed cost of gas file 
rapidjson::Document om_hydro_WITCH;                          // WITCH fixed cost of hydro file 
rapidjson::Document om_nuclear_WITCH;                        // WITCH fixed cost of nuclear file 
rapidjson::Document om_oil_WITCH;                            // WITCH fixed cost of oil file 
rapidjson::Document om_solar_WITCH;                          // WITCH fixed cost of solar file 
rapidjson::Document om_wind_WITCH;                           // WITCH fixed cost of wind file 
rapidjson::Document emissEff_biomass_WITCH;                  // WITCH emission intensity of biomass file
rapidjson::Document emissEff_coal_WITCH;                     // WITCH emission intensity of coal file
rapidjson::Document emissEff_gas_WITCH;                      // WITCH emission intensity of gas file
rapidjson::Document emissEff_hydro_WITCH;                    // WITCH emission intensity of hydro file
rapidjson::Document emissEff_nuclear_WITCH;                  // WITCH emission intensity of nuclear file
rapidjson::Document emissEff_oil_WITCH;                      // WITCH emission intensity of oil file
rapidjson::Document emissEff_solar_WITCH;                    // WITCH emission intensity of solar file
rapidjson::Document emissEff_wind_WITCH;                     // WITCH emission intensity of wind file
rapidjson::Document varCost_biomass_WITCH;                   // WITCH variable cost of biomass file
rapidjson::Document varCost_coal_WITCH;                      // WITCH variable cost of coal file
rapidjson::Document varCost_gas_WITCH;                       // WITCH variable cost of gas file
rapidjson::Document varCost_hydro_WITCH;                     // WITCH variable cost of hydro file
rapidjson::Document varCost_nuclear_WITCH;                   // WITCH variable cost of nuclear file
rapidjson::Document varCost_oil_WITCH;                       // WITCH variable cost of oil file
rapidjson::Document varCost_solar_WITCH;                     // WITCH variable cost of solar file
rapidjson::Document varCost_wind_WITCH;                      // WITCH variable cost of wind file
rapidjson::Document uc_inv_biomass_WITCH;                    // WITCH unit cost of biomass investment file
rapidjson::Document uc_inv_coal_WITCH;                       // WITCH unit cost of coal investment file
rapidjson::Document uc_inv_gas_WITCH;                        // WITCH unit cost of gas investment file
rapidjson::Document uc_inv_hydro_WITCH;                      // WITCH unit cost of hydro investment file
rapidjson::Document uc_inv_nuclear_WITCH;                    // WITCH unit cost of nuclear investment file
rapidjson::Document uc_inv_oil_WITCH;                        // WITCH unit cost of oil investment file
rapidjson::Document uc_inv_solar_WITCH;                      // WITCH unit cost of solar investment file
rapidjson::Document uc_inv_wind_WITCH;                       // WITCH unit cost of wind investment file
double initial_price;                                        // Initial price level to be used for computing WITCH adjustment factor
double WITCH_price_adj;                                      // WITCH price level adjustment factor
int WITCH_year;                                              // Stores the currently simulated year for fetching WITCH input

// Multiple energy technologies
vector<string> ene_tecs;                                     // List of energy technologies
std::map<string, double> d_en_mult_tech;                     // Energy demand by technology
std::map<string, double> uC_prod_mult_tech;                  // Variable cost by technology
std::map<string, double> uC_cap_mult_tech;                   // Fixed cost by technology
std::map<string, double> capacity_mult_tech;                 // Capacity by technology
std::map<string, double> nom_inv_mult_tech;                  // Nominal investment by technology
std::map<string, double> prodCost_mult_tech;                 // Energy production cost by technology
std::map<string, double> maintCost_mult_tech;                // Capacity maintenance cost by technology
std::map<string, double> LDexp_en_mult_tech;                 // Labour demand for capacity expansion by technology
std::map<string, double> LDprod_en_mult_tech;                // Labour demand for energy production by technology
std::map<string, double> LDmaint_en_mult_tech;               // Labour demand for maintenance by technology
std::map<string, double> Rev_en_mult_tech;                   // Energy sales revenue by technology
std::map<string, double> capitalStock_e_mult_tech;           // Nominal value of capital stock by technology
std::map<string, double> deposits_e_mult_tech;               // Bank deposits by technology
std::map<string, double> interestsDeposits_e_mult_tech;      // Deposit interest payments by technology
std::map<string, double> wage_e_mult_tech;                   // Wage bill by technology
std::map<string, double> profitEnergy_e_mult_tech;           // Profit by technology
std::map<string, double> delta_capitalStock_e_mult_tech;     // Change in nominal capital stock by technology
std::map<string, double> emiss_e_mult_tech;                  // Emissions by technology
std::map<string, double> taxes_CO2_e_mult_tech;              // Carbon tax payments by technology
std::map<string, double> dividends_e_mult_tech;              // Dividend payments by technology
std::map<string, double> effective_dividendRate_e_mult_tech; // Dividend payout rate by technology
std::map<string, double> loans_e_mult_tech;                  // Bank loans by technology
std::map<string, double> creditDemand_e_mult_tech;           // Credit demand by technology
std::map<string, double> loan_interest_e_mult_tech;          // Loan interest payments by technology
std::map<string, double> debtRemittances_e_mult_tech;        // Loan principal payments by technology
std::map<string, double> shareDefaultedDebt_e_mult_tech;     // Share of loans in default by technology
std::map<string, int> exiting_e_mult_tech;                   // Indicates whether a given energy technology has defaulted in the current period
std::map<string, double> badDebt_e_mult_tech;                // Debt in default by technology
std::map<string, double> unpaidCtax_e_mult_tech;             // Share of unpaid carbon tax by technology
std::map<string, double> realInv_e_multi_tech;               // Real investment by technology               
std::map<string, double> unit_cost_inv_e_multi_tech;         // Unit cost of investment by technology
std::map<string, RowVector> depreciatedCapital_e_multi_tech; // Depreciated capital by technology
std::map<string, int> e_plant_lifetime;                      // Stores maximum lifetime of energy plants
std::map<string, double> de_premium;                         // Stores technology-specific dividend payout rates
std::map<string, double> inv_redistr_profit_e_multi_tech;    // Share of investment cost which is paid out as profit income instead of wages
