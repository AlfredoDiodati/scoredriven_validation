    ...
    if (t>(t_start_climbox+4))
    {
        ...
        if (flag_capshocks>0)
        {
            ...
            if(flag_capshocks==1)
            {
                for (j=1; j<=N2; j++)
                {
                    rnd=betadev(X_a(5),X_b(5),p_seed);
                    shocks_capstock(j)=rnd;
                }
            }
            else
            {
                shocks_capstock=X_a(5)/(X_a(5)+X_b(5));
            }
        }
        ...
        if(flag_outputshocks>0)
        {
            ...
            {
                shocks_output2=X_a(6)/(X_a(6)+X_b(6));
            }
            ...
            {
                shocks_output1=X_a(6)/(X_a(6)+X_b(6));
            }
        }
        ...
        if (flag_inventshocks>0)
        {
            ...
            {
                shocks_invent=X_a(7)/(X_a(7)+X_b(7));
            }
        }
    }
}
