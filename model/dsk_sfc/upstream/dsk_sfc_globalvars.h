...
//Filenames 
char filename1[64];                                          // File "results" (inv_res)
char filename2[64];                                          // File "A1" (inv_prod1)
char filename3[64];                                          // File "A2" (inv_prod2)
char filename4[64];                                          // File "A1_all" (inv_prodall1)  
char filename5[64];                                          // File "A2_all" (inv_prodall2)
char filename6[64];                                          // File "A1all_en" (inv_prodall1_en)
char filename7[64];                                          // File "A2all_en" (inv_prodall2_en)
char filename8[64];                                          // File "A1all_ef" (inv_prodall1_ef)
char filename9[64];                                          // File "A2all_ef" (inv_prodall2_ef)
char filename10[64];                                         // File "NW1all" (inv_nwall1)
char filename11[64];                                         // File "NW2all" (inv_nwall2)
char filename12[64];                                         // File "NWBall" (inv_nwall3)
char filename13[64];                                         // File "Deb2all" (inv_deball2)
char filename14[64];                                         // File "validation1" (inv_val1)
char filename15[64];                                         // File "validation2" (inv_val2)
char filename16[64];                                         // File "validation3" (inv_val3)
char filename17[64];                                         // File "validation4" (inv_val4)
char filename18[64];                                         // File "validation5" (inv_val5)
char filename19[64];                                         // File "validation6" (inv_val6)
char filename20[64];                                         // File "validation7" (inv_val7)
char filename21[64];                                         // File "validation8" (inv_val8)
char filename22[64];                                         // File "validation9" (inv_val9)
char filename23[64];                                         // File "validation10" (inv_val10)
char filename24[64];                                         // File "validation10" (inv_val10)
char filename25[64];                                         // File "validation10" (inv_val10)
